...
// import { linkedin } from '../src/Config'
...
// const CALLBACK_URL = `${BASE_URL}/linkedin/callback`

// /**
//  * Returns the redirect url for the twitter request
//  */
// async function getRedirectUrl(): Promise<string> {
// 	const redirectRequest = new UrlBuilder(linkedin.REDIRECT_URL)
...
// 	redirectRequest.param('scope', 'r_emailaddress')
...
// 	const requestToken = new Oauth2Request(linkedin.ACCESS_TOKEN_URL, {
// 		clientId: CLIENT_ID,
...
// 			res.end(`<a href="${await getRedirectUrl()}">Login with linkedin</a>`)
// 		} else {
